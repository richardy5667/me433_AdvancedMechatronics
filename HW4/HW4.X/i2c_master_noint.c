...
void setReg(unsigned char address, unsigned char reg, unsigned char value){
    i2c_master_start();
...
unsigned char readReg(unsigned char address, unsigned char reg){
    i2c_master_start();
    address=(address<<1)&0xFE;
    i2c_master_send(address);
    i2c_master_send(reg);
